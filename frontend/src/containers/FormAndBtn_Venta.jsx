...
const FormAndBtn_Venta = () => {
  ...
  // muliplica el valor unitario por la cantidad
  const handleChange = (event) => {
    const { name, value } = event.target
    const vlr_total = value * form.current.vlr_unitario.value
    form.current[name].value = value
    form.current.vlr_total.value = vlr_total
  }
  return (
    <form action="/" ref={form}>
      <div className="main-container-GU-AP-AV">
        ...
        <div className='form-input'>
          ...
          <input type='number' name='cantidad' placeholder='Escribe el valor unitario del producto...' onChange={handleChange} className='form-input-size' required />
        </div>
        ...
        <div className='form-input'>
          ...
          <input type='number' name='vlr_unitario' placeholder='Escribe el valor unitario del producto...' onChange={handleChange} className='form-input-size' required />
        </div>
